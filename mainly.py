...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        root.configure(background="#db7f7f")
        root.configure(highlightbackground="#db7f7f")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#c7fbfc")
        self.Frame1.configure(highlightbackground="#c7fbfc")
        self.Frame1.configure(highlightcolor="black")
        self.Frame1.configure(width=925)

        self.Message6 = Message(self.Frame1)
        self.Message6.place(relx=0.09, rely=0.01, relheight=0.15, relwidth=0.86)
        self.Message6.configure(background="#ff0303")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="#000000")
        self.Message6.configure(highlightbackground="#ff0303")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''KARTHICK RESORT''')
        ...
        self.Button3.configure(text='''2.LOG IN''')
